...
const steps: {
...
}[] = [
  {
    ...
    body: 'A two-minute questionnaire — country, program, funds. No documents yet.',
    stamp: 'Received',
    rotate: -6,
  },
  {
    ...
    body: 'Tested against the official rules for your route — hold periods, thresholds, validity windows.',
    stamp: 'In review',
    rotate: 4,
  },
  {
    ...
    body: 'A score with every weak spot named — the refusal letter you never receive.',
    stamp: 'Assessed',
    rotate: -5,
  },
  {
